...
import { actionDecrement, actionIncrement, actionSetAmount, selectCartProductById } from "../../entities/cart/model/cartSlice";
...
export function useMenuCounter(id) {
  ...
  const onChangeAmount = (e) => {
    ...
    if (isNumber(newAmount) && newAmount >= 0 && newAmount <= 9) dispatch(actionSetAmount({ id, newAmount }));
  };
