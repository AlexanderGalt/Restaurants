...
const isEqualCart = (a, b) => {
  // если мы хотим ререндерить коризну при изменении порядка поизиий в ней.
  const isEqualCartItem = (a, b) => (a.productId === b.productId && a.amount === b.amount ? true : false);
